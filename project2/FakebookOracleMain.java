...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "zhengql"; // replace with your uniqname
    private static String password = "james7201"; // replace with your Oracle password (default: eecsclass)
